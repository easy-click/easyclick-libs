...
function main() {
    ...
    logd("开始执行脚本...")
    var data =  setFetchNodeParam({"labelFilter": "2", "maxDepth": "20", "visibleFilter": "2","excludedAttributes":"visible,enable,nid,id,type,value,enable,selected,depth,index,childcount,accessible"})
    logd(data);
